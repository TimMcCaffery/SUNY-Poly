...
public class ClubJsonResponseListener implements Listener<JSONObject> {
	...
	public ClubJsonResponseListener(Context context, BaseAdapter adapter, List<JsonItem> items) {
	...
	public void onResponse(JSONObject response) {
		// Parse JSON results
		JsonUtils.fillListclub(response, items);
